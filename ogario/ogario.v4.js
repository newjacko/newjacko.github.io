...
var legendflags = ["author of agar.io", "author of lm", "yugoslavia", "virgil", "vaseline", "the hood", "targaryen", "tajikistan", "slovakia", "sherbert", "scott", "peter", "pepsi", "nose", "nivea", "legend mod", "legend clan", "kennedy", "kayo", "john", "israel", "illuminati", "heisenberg", "gordon", "eye of sauron", "dollar", "coca cola", "brian", "bread", "beavis", "bart", "baghdadi", "alaska", "alan", "8 ball",
    ...
    "patriarchy", "peru", "pewdiepie", "piccolo", "pokerface", "portugal", "prodota", "prussia", "putin", "qing-dynasty", "quebec", "queen", "reddit", "romania", "mistik", "3ezzy", "3LK", "7MODKA", "agarbot.OᐯＨ", "Agarmurfs", 
    "alejo", "alejoyoutube", "Alejoyt2", "Araizon", "Ashwin", "Ashwinyt", "Brax", "Bulba", "Char", "DNA Clan", "EvilMonkey", "GDK Xmas", "GetDeadKid", "GURI", "Hero", "MAJNOON", "NbRhmi", "OP-BOTS.𝗖𝗢𝗠", "Pika", "Sarok1", 
    "Sarok2", "silver", "Skills", "Skillsyt", "Sneddy Gaming", "SonicGames", "Sparky", "Squi", "Timid", "Togoman", "twisted", "Woobs", "YemeniYT"
